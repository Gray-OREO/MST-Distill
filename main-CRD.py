...
from utils import get_data, get_dataset, seed_all, get_Tmodules, get_Smodules, hooks_builder
import copy
import time
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        tra_LOSS_s, tra_LOSS_task, tra_LOSS_crd = 0, 0, 0
